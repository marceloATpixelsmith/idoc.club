...
AUTH-CRYPTO-004, and AUTH-DEPENDENCY-001 (narrowing AUTH-SECRET-004 without fully closing it), and Slice 6
(Privacy and logging) closed AUTH-IDENTITY-003, AUTH-API-003, AUTH-LOG-001, AUTH-LOG-003, and
AUTH-PRIVACY-001, each with real behavioral evidence, current status is **139 verified, 2
implemented-but-unverified, 7 partial, 0 missing, and 7 not-applicable**. Consequently, the table below has
exactly **9 applicable non-verified controls**.
