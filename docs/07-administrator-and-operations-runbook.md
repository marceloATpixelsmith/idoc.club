...
Administrators and Super Admins manage seminars at `/admin/seminars`: create, edit, publish, cancel, move back to draft, search/filter, review registrations, mark a manual payment received, and export registrations to CSV. Members register and cancel their own registrations at `/dashboard/seminars`. Deploy migration `0041` before use.
