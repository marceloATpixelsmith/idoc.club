...
CREATE TABLE "idoc"."payment_refunds" (
 ...
 "idempotency_key" varchar(255) CONSTRAINT "payment_refunds_idempotency_key_unique" NOT NULL UNIQUE, "amount_cents" integer NOT NULL, "currency" varchar(3) DEFAULT 'EUR' NOT NULL,
