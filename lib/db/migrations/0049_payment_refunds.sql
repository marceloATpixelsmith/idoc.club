...
CREATE TABLE "idoc"."payment_refunds" (
 "id" serial PRIMARY KEY NOT NULL, "seminar_registration_id" integer REFERENCES "idoc"."seminar_registrations"("id"),
 "membership_payment_id" integer REFERENCES "idoc"."payments"("id"), "external_refund_id" varchar(255) UNIQUE,
 "idempotency_key" varchar(255) NOT NULL UNIQUE, "amount_cents" integer NOT NULL, "currency" varchar(3) DEFAULT 'EUR' NOT NULL,
 "status" varchar(30) NOT NULL, "reason" text NOT NULL, "administrator_id" integer REFERENCES "idoc"."users"("id"),
