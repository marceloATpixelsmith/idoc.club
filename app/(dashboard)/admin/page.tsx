...
export default async function AdminPage() {
  ...
  return <main className="flex-1 p-8">
    ...
    <Link className="mt-2 block underline" href="/admin/reconciliation">Stripe reconciliation</Link>
    {isSuperAdmin && <Link className="mt-2 block underline" href="/admin/security">Security operations — Super Admin</Link>}
  </main>;
}
