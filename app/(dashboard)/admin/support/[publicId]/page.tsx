...
export default async function AdminSupportThread({ params, searchParams }: { params: Promise<{ publicId: string }>; searchParams: Promise<{ returnTo?: string }> }) {
  ...
  const returnTo = query.returnTo?.startsWith('/admin/support') ? query.returnTo : '/admin/support';
