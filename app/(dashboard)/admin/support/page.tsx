...
const TABLE_KEYS = ['q', 'category', 'status', 'assigned', 'activityFrom', 'activityTo', 'filters', 'joinOperator', 'sort', 'direction', 'page', 'pageSize', 'column', 'columnOrder'];
...
export default async function AdminSupportPage({ searchParams }: { searchParams: Promise<SupportSearchParams> }) {
  ...
  // listAdminConversations still supports those params for direct/programmatic callers, but a
  // stale or shared URL reaching this page must not have them silently applied with no toolbar
