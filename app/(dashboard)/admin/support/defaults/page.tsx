...
export default async function SupportDefaultsPage() {
  ...
  return <main className="space-y-6 p-8"><header><h1 className="text-2xl font-semibold">Support category defaults</h1><p className="text-muted-foreground">Defaults apply only to conversations created after a change.</p></header>
