...
export function OnboardingForm() {
  ...
  return <form action={action} className="space-y-4">
    ...
    <label className="block">Professional classification<select className="block w-full border p-2" name="classification" required><option value="">Select</option><option value="judge">Judge</option><option value="steward">Steward</option><option value="judge_steward">Judge + Steward</option><option value="veterinarian">Veterinarian</option></select></label>
    <fieldset className="space-y-4 border p-4"><legend>Official information (required for Judge and/or Steward)</legend>
      ...
      <Select label="Official Status as Judge" name="judgeStatus" values={JUDGE_STATUSES} />
      <label className="block">Are you a Technical Delegate?<select className="block w-full border p-2" name="isTechnicalDelegate"><option value="no">No</option><option value="yes">Yes</option></select></label>
      <Select label="Official Status as Steward" name="stewardStatus" values={STEWARD_STATUSES} />
    </fieldset>
