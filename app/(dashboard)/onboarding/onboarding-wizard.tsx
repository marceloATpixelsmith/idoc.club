      ...
      <form action={action} className="space-y-5">
        ...
        <fieldset className="space-y-3 rounded-lg border border-gray-200 p-4">
          ...
          <label className="flex items-start gap-2 text-sm text-gray-700">
            ...
            />
            <span>
              I have read and agree to the <a className="underline" href="/terms" target="_blank">Terms of Service</a> and I acknowledge that I am
              signing up for a recurring membership fee that will be automatically charged to this card every year (until I specifically ask to
              terminate my account in time).*
            </span>
          </label>
          <label className="flex items-start gap-2 text-sm text-gray-700">
            <input
          ...
          <label className="flex items-start gap-2 text-sm text-gray-700">
            ...
            <span>
              Keep me updated on IDOC events, workshops, and certifications (if not checked you will still receive emails regarding your
              membership and this website, but you will miss out on IDOC events).
            </span>
          </label>
        </fieldset>
