...
export default async function MemberSupportThread({ params }: { params: Promise<{ publicId: string }> }) {
  ...
  // See dashboard/support/page.tsx for why this catches reactively rather than re-deriving the
  // entitled/non-admin policy proactively -- same AUTH-AUTHZ-009-class gap, same fix shape.
  let conversation;
  try {
