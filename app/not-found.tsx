  ...
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-background px-5 py-16">
      <div className="w-full max-w-lg rounded-3xl border border-border bg-card px-6 py-12 text-center shadow-sm sm:px-12">
        ...
        <Link href="/" className="mx-auto mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-sm font-medium uppercase tracking-wide text-primary-foreground transition-opacity hover:opacity-90">
