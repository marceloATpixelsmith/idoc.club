...
export function PasswordStep() {
  const [state, formAction, pending] = useActionState<ActionState, FormData>(completeSignup, { error: '' });
  ...
  return (
    <AuthShell title="Create account">
      <form action={formAction} className="space-y-4">
        <div>
          <Label className="mb-1.5 block text-sm font-medium text-gray-700" htmlFor="password">Create Password</Label>
