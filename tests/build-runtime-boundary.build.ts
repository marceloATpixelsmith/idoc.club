...
test('production modules contain server-only boundaries and no fake credential fallbacks', () => {
  const privileged = ['lib/db/drizzle.ts', 'lib/auth/session.ts', 'lib/payments/stripe.ts', 'lib/payments/manual-payments.ts', 'lib/payments/reconciliation-scan.ts', 'lib/security/encrypted-payload.ts', 'lib/notifications/account-delivery.ts', 'lib/notifications/mailchimp-transactional.ts', 'lib/notifications/mailchimp-marketing.ts', 'lib/notifications/profile-change-delivery.ts', 'lib/notifications/renewal-notices.ts', 'lib/membership/status-actions.ts', 'lib/membership/role-grants.ts', 'lib/membership/exports.ts', 'lib/runtime/configuration.ts', 'app/api/cron/account-delivery/route.ts', 'app/api/cron/reconciliation-scan/route.ts', 'app/api/cron/renewal-notice-scan/route.ts', 'app/api/cron/renewal-notice-delivery/route.ts', 'app/api/admin/export/members/route.ts', 'app/api/admin/export/payments/route.ts', 'app/api/admin/export/audit-log/route.ts', 'app/api/admin/export/notifications/route.ts'];
